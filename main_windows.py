#!/usr/bin/env python3
"""
Earth Launcher - Windows Test Version
This version works on Windows for testing without GPIO hardware
"""
...
class GameLauncher:
    def __init__(self):
        ...
        pygame.display.set_caption("Earth Launcher - Windows Test")
    ...
    def handle_input(self):
        """Handle keyboard input for Windows testing"""
    ...
    def draw(self):
        ...
        # Draw title
        title = self.font_large.render("Earth Launcher - Windows Test", True, WHITE)
        self.screen.blit(title, (20, 20))
        
        # Draw instructions
        instructions = [
            "Arrow Keys: Navigate | Enter: Install/Run | Backspace: Delete | Escape: Exit | R: Refresh",
